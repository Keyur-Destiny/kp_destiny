...
class PosSessionInherit(models.Model):
    ...
    def _loader_params_stock_quant(self):
        return {'search_params': {'domain': [("location_id.usage", "in", ["internal"])], 'fields': ['product_id','location_id','quantity']}}
    ...
    def _loader_params_stock_warehouse(self):
        return {'search_params': {'domain': [], 'fields': ['name','code','lot_stock_id']}}
    ...
    def _loader_params_stock_location(self):
        return {'search_params': {'domain': [], 'fields': ['id','display_name']}}
